...
// gönderilen konu: Metin, gönderilen veri:Merhaba Dunya
#include <ESP8266WiFi.h>
#include <MQTTClient.h>

const char *ssid = "xxxx";                 // bağlanılacak olan kablosuz ağın SSID si
const char *password = "xxxx";                  // bağlanılacak olan kablosuz ağın şifresi
...
void loop() 
{
  ...
  mqtt_istemci.publish("Metin","Merhaba Dunya");	// Metin konusuna Merhaba Dunya yazısını gönder
